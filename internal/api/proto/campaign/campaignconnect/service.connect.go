...
const (
	...
	CampaignServiceName = "rpc_campaign.CampaignService"
)
...
const (
	...
	// CreateCampaign RPC.
	CampaignServiceCreateCampaignProcedure = "/rpc_campaign.CampaignService/CreateCampaign"
	// CampaignServiceGetCampaignProcedure is the fully-qualified name of the CampaignService's
	// GetCampaign RPC.
	CampaignServiceGetCampaignProcedure = "/rpc_campaign.CampaignService/GetCampaign"
)

// CampaignServiceClient is a client for the rpc_campaign.CampaignService service.
...
// NewCampaignServiceClient constructs a client for the rpc_campaign.CampaignService service. By
...
func NewCampaignServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CampaignServiceClient {
	...
	campaignServiceMethods := campaign.File_proto_campaign_service_proto.Services().ByName("CampaignService").Methods()
...
// CreateCampaign calls rpc_campaign.CampaignService.CreateCampaign.
...
// GetCampaign calls rpc_campaign.CampaignService.GetCampaign.
func (c *campaignServiceClient) GetCampaign(ctx context.Context, req *connect.Request[campaign.GetCampaignRequest]) (*connect.Response[campaign.GetCampaignResponse], error) {
	return c.getCampaign.CallUnary(ctx, req)
}

// CampaignServiceHandler is an implementation of the rpc_campaign.CampaignService service.
...
func NewCampaignServiceHandler(svc CampaignServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/rpc_campaign.CampaignService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCampaignServiceHandler) CreateCampaign(context.Context, *connect.Request[campaign.CreateCampaignRequest]) (*connect.Response[campaign.CreateCampaignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rpc_campaign.CampaignService.CreateCampaign is not implemented"))
}

func (UnimplementedCampaignServiceHandler) GetCampaign(context.Context, *connect.Request[campaign.GetCampaignRequest]) (*connect.Response[campaign.GetCampaignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rpc_campaign.CampaignService.GetCampaign is not implemented"))
}
