...
func (x *GetCampaignRequest) Reset() {
	*x = GetCampaignRequest{}
	mi := &file_proto_campaign_get_proto_msgTypes[0]
...
func (*GetCampaignRequest) Descriptor() ([]byte, []int) {
	return file_proto_campaign_get_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetCampaignResponse) Reset() {
	*x = GetCampaignResponse{}
	mi := &file_proto_campaign_get_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCampaignResponse) Descriptor() ([]byte, []int) {
	return file_proto_campaign_get_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetCampaignResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *GetCampaignResponse) GetBeginAt() *timestamppb.Timestamp {
	if x != nil {
		return x.BeginAt
	}
	return nil
...
var File_proto_campaign_get_proto protoreflect.FileDescriptor

const file_proto_campaign_get_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_proto_campaign_get_proto_rawDescData []byte
)

func file_proto_campaign_get_proto_rawDescGZIP() []byte {
	file_proto_campaign_get_proto_rawDescOnce.Do(func() {
		file_proto_campaign_get_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_campaign_get_proto_rawDesc), len(file_proto_campaign_get_proto_rawDesc)))
	})
	return file_proto_campaign_get_proto_rawDescData
}

var file_proto_campaign_get_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_campaign_get_proto_goTypes = []any{
	(*GetCampaignRequest)(nil),    // 0: rpc_campaign.GetCampaignRequest
	(*GetCampaignResponse)(nil),   // 1: rpc_campaign.GetCampaignResponse
...
func init() { file_proto_campaign_get_proto_init() }
func file_proto_campaign_get_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_campaign_get_proto_rawDesc), len(file_proto_campaign_get_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		...
		MessageInfos:      file_proto_campaign_get_proto_msgTypes,
	}.Build()
	File_proto_campaign_get_proto = out.File
	file_proto_campaign_get_proto_goTypes = nil
	file_proto_campaign_get_proto_depIdxs = nil
}
